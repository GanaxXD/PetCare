              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    pedido.medicamento.length > 30 ?
                    Text("Medicamento: "+ pedido.medicamento.substring(0,30)+"...", style: TextStyle(fontSize: 12, fontWeight: FontWeight.normal),):
                    Text("Medicamento: "+ pedido.medicamento, style: TextStyle(fontSize: 12, fontWeight: FontWeight.normal),),
